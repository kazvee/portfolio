...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, videoUrl, title }) => {
  ...
  return createPortal(
    <div
      ...
      <div className="relative bg-[#482B56] rounded-lg w-full max-w-4xl h-auto max-h-[80vh] p-4 flex flex-col">

        <div className="flex justify-between items-center mb-4">
          <h2 className="text-white font-semibold">📺 Demo Video | {title}</h2>
          <button
            onClick={onClose}
