...
const projectsData = [
  ...
  },
  {
    ...
    tools: '⚙️ React, JavaScript, HTML, CSS, Node.js, Express, Axios, Bootstrap, PostgreSQL, Netlify',
  ...
  },
  {
    ...
    tools: '⚙️ JavaScript, Node.js, Express, PostgreSQL, EJS (Embedded JavaScript),HTML, CSS, SASS',
